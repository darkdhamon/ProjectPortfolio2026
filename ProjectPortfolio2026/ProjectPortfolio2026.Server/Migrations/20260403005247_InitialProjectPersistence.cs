        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LongDescriptionMarkdown = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectDeveloperRoles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProjectDeveloperRoles_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectCollaboratorRoles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProjectCollaboratorRoles_ProjectCollaborators_ProjectCollaboratorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectCollaboratorRoles_ProjectCollaboratorId",
                table: "ProjectCollaboratorRoles",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectDeveloperRoles_ProjectId",
                table: "ProjectDeveloperRoles",
                column: "ProjectId");
