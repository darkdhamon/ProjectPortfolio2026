...
internal static partial class ResumeParsingUtilities
{
    ...
    public static bool LooksLikeUtf8TextContent(MemoryStream content)
    {
    ...
    public static string ReadTextBuffer(MemoryStream content)
    {
    ...
    public static string ExtractPdfLiteralText(string rawPdf)
    {
    ...
    public static ResumeHeader ParseHeader(IReadOnlyList<string>? rawLines)
    {
    ...
    public static string? JoinSectionParagraph(IReadOnlyList<string>? rawLines)
    {
        var lines = CleanSectionLines(rawLines);
        return lines.Count == 0 ? null : string.Join(" ", lines);
    }

    public static List<ResumeWorkExperienceEntry> ParseWorkExperience(IReadOnlyList<string>? rawLines)
    {
    ...
    public static List<ResumeEducationEntry> ParseEducation(IReadOnlyList<string>? rawLines)
    {
    ...
    public static List<ResumeSkillSection> ParseSkillSections(IReadOnlyList<string>? rawLines)
    {
        var lines = CleanSectionLines(rawLines);
        if (lines.Count == 0)
        {
    ...
    public static List<ResumeCertification> ParseCertifications(IReadOnlyList<string>? rawLines)
    {
        return BuildBlocks(rawLines)
            .Select(block =>
            {
    ...
    public static List<ResumeProjectEntry> ParseProjects(IReadOnlyList<string>? rawLines)
    {
        return BuildBlocks(rawLines)
            .Select(block =>
            {
    ...
    public static List<ResumeLanguage> ParseLanguages(IReadOnlyList<string>? rawLines)
    {
    ...
    public static List<ResumeAward> ParseAwards(IReadOnlyList<string>? rawLines)
    {
        return BuildBlocks(rawLines)
            .Select(block =>
            {
    ...
    public static List<ResumeVolunteerExperienceEntry> ParseVolunteerExperience(IReadOnlyList<string>? rawLines)
    {
        return BuildBlocks(rawLines)
            .Select(block =>
            {
    ...
    public static List<ResumePublication> ParsePublications(IReadOnlyList<string>? rawLines)
    {
        return BuildBlocks(rawLines)
            .Select(block =>
            {
    ...
    public static List<ResumeReference> ParseReferences(IReadOnlyList<string>? rawLines)
    {
        return BuildBlocks(rawLines)
            .Select(block =>
            {
    ...
    public static List<ResumeCustomSection> ParseAdditionalSections(IReadOnlyDictionary<string, List<string>> sections)
    {
        return sections
            .Where(pair => !pair.Key.Equals("__header__", StringComparison.OrdinalIgnoreCase) &&
                           !StandardSectionKeys.Contains(pair.Key, StringComparer.OrdinalIgnoreCase))
            .Select(pair =>
            {
                var cleanedItems = CleanSectionLines(pair.Value);
                var title = cleanedItems.FirstOrDefault();
                var bodyItems = cleanedItems.Skip(1).ToList();

                return new ResumeCustomSection
                {
                    Title = title,
                    Items = bodyItems,
