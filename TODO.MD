...
- Scan downloaded configured resume files with installed antivirus before parsing. Tracked in issue #156.
- Validate admin resume configuration field lengths before save. Tracked in issue #157.
